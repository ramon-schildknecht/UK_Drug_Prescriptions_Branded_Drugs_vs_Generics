...
There are 1260 missing values for the generics data. There are totally 4142 in our joined branded drugs and generics table. The missing ratio is therefore about 30%. Conclusion: There are close to 70% of all branded drugs with a generic. 
...
### to do: I must need the branded_list as well as the generic_list here ### 
...
(p_nic_per_item <- plot_ly(x = ~nic_per_item_generic, name = "Generic price per item", type = "box", boxpoints = "all", jitter = 0.25) %>%
  add_trace(x = ~nic_per_item_branded, name = 'Original price per item'))
